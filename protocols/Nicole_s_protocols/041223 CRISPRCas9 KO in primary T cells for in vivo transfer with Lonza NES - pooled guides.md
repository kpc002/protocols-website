---
title: "041223 CRISPRCas9 KO in primary T cells for in vivo transfer with Lonza NES - pooled guides"
description: "Protocol for pooled-guide CRISPR-Cas9 knockout in primary T cells using Lonza nucleofection before in vivo transfer."
order: 10
...
> **Materials**
  ...
  - Recombinant Cas9 protein, 40uM, @ -80’C

  - 20bp sgRNAs+80mer scaffold with chemical modification

  - R10 (RPMI + 10% FCS, glutamine, antibiotics, 50 nM BME, NEAA, HEPES)

**Enrich CD8+ T cells** – naïve or activated

  - **Do this one day prior to this protocol.**

**CRISPR/Cas9 electroporation**

1.  To make a Cas9/RNA complex, mix guides plus tracr RNA as below in PCR tubes:
    
    1.  sgRNA thy1 guide only control
    
    2.  sgRNA thy1 guide plus guide of 1<sup>st</sup> target
    
    3.  sgRNA thy1 guide plus guide of 2<sup>nd</sup> target
...
<!-- end list -->
  ...
  - my guides are at 300uM concentration (stock).

  - Pool multiple guides together - make 100uM “working stock” before using
    
      - Example pool 3 guides
  ...
  - Set up as follows:
      ...
      - Experimental (x number of groups needed)
        ...
        <!-- end list -->
          ...
          - **3uL guide of pooled guides (diluted to 50uM)**
...
2.  Add 2.38uL 40uM Cas9 enzyme to each tube (-80’, middle shelf, middle rack). DO NOT MIX. Gently flick the tube to mix sgRNAs with Cas9 and spin down briefly to collect drops from the sides of the tube. Incubate for 20 minutes at room temperature for complex formation.
...
10. Electroporate cells by putting the nucleofector strip into the Lonza nucleofector and as depicted, start the program (use DS137 program, which is best for activated CD8 mouse T cells in P3 buffer).
...
14. For *in vivo* adoptive transfer, resuspend in PBS at desired concentration and adoptively transfer into recipient mice via intravenous injection. Keep some cells going in culture for future flow and KO validation with flow or Sanger sequencing.
