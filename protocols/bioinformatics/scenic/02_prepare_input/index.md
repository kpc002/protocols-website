...
date: last-modified
description: 
  Creating the input files for pySCENIC
filters:
   - lightbox
lightbox: auto
---
...
![Highest expressed genes](pySCENIC_part1_6_1.png){#fig-high-genes}
...
![Violin plot of nGenes, nUMI and pctMito](pySCENIC_part1_11_1.png){#fig-qc1}

![Scatter nUMI vs pctMito](pySCENIC_part1_11_2.png){#fig-qc2}

![Scatter nUMI vs nGenes](pySCENIC_part1_11_3.png){#fig-qc2}

Quality control plots
:::

{{< lightbox src="" caption="" >}} 
{{< lightbox src="pySCENIC_part1_11_2.png" caption="" >}}
{{< lightbox src="pySCENIC_part1_11_3.png" caption="" >}}

We use this plots to set cutoffs of the maximal number of genes (anything above that might be doublets) and the maximal percentage of allowed mitochrondial genes.
...
![Highly variable genes](pySCENIC_part1_22_1.png){#fig-hvg}
...
![PCA plot coloured by tissue](pySCENIC_part1_25_1.png){#fig-pca}
...
![PCA variance ratio](pySCENIC_part1_26_0.png){#fig-pca-variance}
...
![UMAP plots](pySCENIC_part1_30_0.png){#fig-umap}
...
```
![TSNE plots](pySCENIC_part1_32_0.png){#fig-tsne}
