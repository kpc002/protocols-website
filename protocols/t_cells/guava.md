...
3.  Transfer 5uL of cells from step 1a into each well
...
5.  Make 2x Guava master mix by diluting Guava solution in PBS
    -   Calculate to make enough volume for 195uL total volume per sample
6.  Prepare epi vials, in the vials combine 5uL of cell mixture from step 4 to 195uL of the Guava master mix for each sample
...
2.  Quick clean:
    ...
    -   On the acquisition page, click "quick clean" option and follow prompt
        -   1 minute of ICF
    -   After the cleaning is done, put DiH2O back on and turn off machine and computer
3.  Long Clean
