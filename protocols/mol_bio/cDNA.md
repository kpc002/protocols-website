...
{{< details "Old SuperScript II Protocol" >}}

{{< hint warning >}}
This protocol uses superscript II.
{{</ hint>}}

- Mix 9 ul RNA, 1ul dNTP, 1ul random hexamer (50 ng/ul).  
  {{< hint info >}}
...
- Add 1ul superscript II to each tube. 
- PCR program: 
  - RT 10 min 
  - 42C 50 min 
  - 70 15 min 
- Chill on ice. 
- Add 1 ul RNAse H and incubate 37C 20 min. 
